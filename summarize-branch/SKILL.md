...
4. Create a summary file at `docs/summaries/{slugified-branch-name}-summary.md`
...
6. Check if a transient progress file exists at `docs/{slugified-branch-name}-progress.md`
